  ...
  return (
    <div className="view-employee-page">
      <div className="view-employee-container">
        ...
        <button className="btn btn-edit-employee-page-edit" onClick={handleEditEmployee}> Edit </button>
        <button className="btn btn-view-employees-page-back" onClick={handleBackToList}> Back to List </button>
        </div>
      </div>
    </div>
  );
